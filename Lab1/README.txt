...
- Para compilar el proyecto simplemente ejecutamos "make" en la terminal desde el directorio donde se encuentra el Makefile. Se crearan dos nuevos directorios: obj/ que contiene los archivos .o y exec/ que contiene los ejecutables del proyecto.
- Para ejecutar el programa ejecutamos en la terminal "make solution".
- Con "make clean" podemos borrar los archivos creados y dejar el proyecto en estado de fábrica.
